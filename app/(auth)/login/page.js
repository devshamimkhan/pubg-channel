...
export default function LoginPage() {
  ...
  return (
    <div className="auth-card">
      <Link href="/" className="absolute top-[18px] left-[20px] flex items-center gap-[5px] text-[13px] text-[var(--text-muted)] no-underline hover:text-[var(--text-main)] transition-colors">
      ...
      <form onSubmit={handleLogin}>
        ...
        <div style={{ marginBottom: '14px' }}>
          <div className="form-label">
            Password
            <Link href="#" className="text-[var(--gold)] text-[11px] normal-case font-medium hover:underline">Forgot password?</Link>
          </div>
      ...
      <div className="footer-note">
        Don&apos;t have an account? <Link href="/register">Register here</Link><br/>
        <span className="dim">By continuing you agree to our <Link href="#">Terms</Link> &amp; <Link href="#">Privacy Policy</Link></span>
      </div>
    </div>
  );
}
